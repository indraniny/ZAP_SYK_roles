...
# =============================================================================
    ...
    K1=10**(2.788532849)#SYK concentration
    K2=1
...
#############################################    
    ...
    # K1=10**(2.888665852)#SYK concentration
    # K2=1
    # K3=10**(2.911034846) #ZAP concentration
    # KSA=10**(-4.202320709)
    # KST=10**(-4.00629811)
    ...
    # Model d
    # K1=10**(2.672440868)#SYK concentration
    # K2=1
    # K3=10**(2.911034846) #ZAP concentration
    # KSA=10**(-3.466526711)
    # KST=10**(-3.955852847)
...
#0. Bionetgen parameter set 
    ...
    model = bionetgen.bngmodel("BioModel_ZAP70_SYK_v8_test1f.bngl") #homodimer-gamma code
...
#2.Interpolate PZAP  from 600 points to 2000 points   
   ...
   # plt.plot(T,avg_ZAP,'m*',tnew,PZAP,'g-') 
    ...
    plt.plot(tnew,PZAP,'m*',label='pZAP') 
    plt.plot(tnew,PSYK,'g',linestyle='--', linewidth=6,label='pSYK') 
...
#5. Ca Signal from the ODE model uisng the PSYK signal   ##########PSYK
  ...
  #7. Finding objective function only at t>60 sec
    ...
    #plt.show()
    # Plotting the curves with red color gradient
    #plt.plot(C1_x, C1_y, color=cmap(1.0), linewidth=2.0,linestyle='-', label='46L+50F')
    #plt.plot(C2_x, C2_y, color=cmap(0.9),linewidth=2.0,linestyle='-', label='46L+50F+53V')
    #plt.plot(C3_x, C3_y, color=cmap(0.8),linewidth=2.0,linestyle='-', label='hCD3z')
    #plt.plot(C4_x, C4_y, color=cmap(0.7),linewidth=2.0,linestyle='-', label='46L+53V')
    #plt.plot(C5_x, C5_y, color=cmap(0.6), linewidth=2.0,linestyle='-',label='mFceR1g')
    #plt.plot(C6_x, C6_y, color=cmap(0.5), linewidth=2.0,linestyle='-',label='46L')
    #plt.plot(C7_x, C7_y, color=cmap(0.4),linewidth=2.0,linestyle='-', label='WT')
