...
def SYK_only(n,K1,KSA,KST,C1s,C2s,gs,time,exp_data,dir_name):
  ...
  #7. Finding objective function only at t>25 sec
   ...
   #8. Delete existing bionetgen output folder and bionetgen model
    for i in range(0,n,1):
        path="/home/gddaslab/ixn004/ZAP_SYK_JAN_2024/FEB_RUNs_2024_kill_CD3z/cost_sum2e/"+dir_name+"_SYK_HPC_output_"+str(i)
        shutil.rmtree(path)

    os.remove("/home/gddaslab/ixn004/ZAP_SYK_JAN_2024/FEB_RUNs_2024_kill_CD3z/cost_sum2e/"+dir_name+"_Model_SYK.bngl")
    # for i in range(0,n,1):
